...
public abstract class EarthquakeMarker extends CommonMarker
{
	...
	public void showTitle(PGraphics pg, float x, float y)
	{
		...
		int x_base = (int) (x-10);
		int y_base = (int) (y+25);
		int titleLength = this.getTitle().length();
		
		pg.fill(150, 150, 150); // the rectangle under the text
		pg.rect(x-15, y+10, (titleLength * 5) + (titleLength + 15), 20);
		
		pg.fill(0, 0, 0);  // the actual text of the pop-up
		pg.text(this.getTitle(), x_base, y_base);
